  ...
  return (
    <footer className="bg-black text-gray-400 px-6 py-12 w-screen">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-center md:justify-start gap-6 text-white text-xl mb-8">
        ...
        <div className="flex flex-wrap justify-between gap-8 text-sm">
          <div className="flex flex-col gap-2 p-4 md:p-0 min-w-37.5">
        ...
        <p className="mt-10 text-xs text-gray-500 flex justify-center">
          © Developed by Kaustav Roy.
        </p>
      </div>
    </footer>
  );
